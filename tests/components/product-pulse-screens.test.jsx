...
describe("ProductPulse screens", () => {
  ...
  it("keeps the catalog scan action available when product rows exist", async () => {
    ...
    expect(momentumLink).toHaveTextContent("Accelerating");
    expect(momentumLink).not.toHaveTextContent("Hot");
    expect(momentumLink).toHaveTextContent(/\b8[6-8]\b/);
    ...
    expect(document.body.querySelector(".ppMomentumToastHero")).toHaveTextContent(/Accelerating\s*·\s*8[6-8]\/100/);
    expect(document.body.querySelector(".ppMomentumToastHero")).toHaveTextContent(/Hot\s*·\s*High confidence/);
  ...
  it("renders granular sentiment and language evidence in Product Diagnosis", () => {
    ...
    expect(within(issuesPanel).getByText("Diagnostic review")).toBeInTheDocument();
    expect(within(issuesPanel).getByText("Evidence-backed product issues found in the latest Product Diagnosis.")).toBeInTheDocument();
