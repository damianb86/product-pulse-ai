...
function buildWatchChangeReportNarrativePrompt({ productTitle, report }) {
  ...
  return [
    ...
    "Focus first on concrete source activity since the previous Watchlist run: new orders, returns, refunds, reviews, rating movement, new reason text, sentiment, repeated language, or product-content changes.",
    "Treat product risk, return rate, refund rate, confidence, revenue at risk, margin at risk and momentum as secondary calculated context. Mention them after concrete source activity, and only when present in the data.",
    "Mention new returns, refunds, reviews, orders, reasons, sentiment, repeated language, rating movement, or content changes only when present in the data.",
