...
import { aiAppMutationResultToPresentationBlock } from "../ai/appMutations/presentation";
...
const aiAppMutationSaveRequestSchema = z.object({
  proposalId: z.string().trim().min(1).max(320),
  editedFields: z.record(z.string(), z.unknown()).optional().refine(
...
export const action = async ({ request }) => {
  ...
  const block = aiAppMutationResultToPresentationBlock(result.data.result, {
