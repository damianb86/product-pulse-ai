...
function buildFinalReportPrompt(input, classification, contentGaps, emergentSentiments) {
  return [
    ...
    "When review evidence comes from multiple providers, you may also create separate evidence_synthesis_sections entries for each review provider so provider tabs can show scoped interpretation. Set source_title and source_key for provider-specific review sections, and do not reuse the same body across CSV, Judge.me, ChatMe, or any other external review provider.",
