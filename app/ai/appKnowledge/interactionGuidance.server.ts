...
function methodologyOptions(): AppInteractionGuidanceOption[] {
  return [
    ...
    },
    {
      id: "quickscan",
      label: "Catalog Scan",
      description: "Explica cómo Catalog Scan selecciona candidatos.",
      examplePrompt: "Cómo funciona Catalog Scan y cómo elige candidatos?",
      category: "explain",
      requiresProductContext: false,
      requiresConfirmation: false,
    ...
    },
    {
      ...
      description: "Explica qué hace Product Diagnosis y qué datos puede actualizar dentro de ProductPulse.",
      examplePrompt: "Qué diferencia hay entre Catalog Scan y Product Diagnosis?",
      category: "explain",
      requiresProductContext: false,
      requiresConfirmation: false,
