...
export function buildAiChatInstructions(input: {
  ...
  return [
    ...
    "If a formula, setting, screen, score, or workflow detail is not documented in the app knowledge tools, say that ProductPulse does not document it clearly yet instead of guessing.",
