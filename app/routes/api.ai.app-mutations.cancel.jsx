...
import { aiAppMutationCancellationToPresentationBlock } from "../ai/appMutations/presentation";
...
const aiAppMutationCancelRequestSchema = z.object({
...
export const action = async ({ request }) => {
  ...
  const block = aiAppMutationCancellationToPresentationBlock(result.data.proposal);
  return Response.json(
    {
      status: "success",
